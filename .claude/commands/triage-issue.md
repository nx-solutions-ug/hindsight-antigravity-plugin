...
4. It will implement the minimal, correct change in line with `rules/AGENTS.md` conventions, including tests.
5. It will run the full quality gates (`bun run build`, `bun test`) and only proceed if both pass.
